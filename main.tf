...
resource aws_launch_configuration "conf" {
  ...
  user_data = join("", concat([
    ...
    "BANYAN_ACCESS_EVENT_CREDITS_LIMITING=${var.access_event_rate_limiting_enabled} ",
    "BANYAN_ACCESS_EVENT_CREDITS_MAX=${var.rate_limiting_max_credits} ",
    "BANYAN_ACCESS_EVENT_CREDITS_INTERVAL=${var.rate_limiting_credit_interval} ",
    "BANYAN_ACCESS_EVENT_CREDITS_PER_INTERVAL=${var.rate_limiting_credits_per_interval} ",
    "BANYAN_ACCESS_EVENT_KEY_LIMITING=${var.rate_limiting_by_key} ",
    "BANYAN_ACCESS_EVENT_KEY_EXPIRATION=${var.rate_limiting_key_expiration} ",
